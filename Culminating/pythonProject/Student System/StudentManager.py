...
class StudentManager:
    ...
    def Modify(self, file_name, content):
        file_Path = os.path.join(self.folder_Path, file_name)
...
class StudentInfoManager:
    ...
    def student_Show_Window(self, file_Name, content):
        try:
            self.student_info_window = tk.Toplevel(self.root)
    ...
    def student_Delete(self, file_Name):
        try:
            confirm = messagebox.askyesno("WARNING!", f"Are you sure you want to delete '{file_Name}'?")
            if confirm:
